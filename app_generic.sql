...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-05-2023 a las 19:00:05
...
--
-- Base de datos: `app_generic`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `app_ads`
--
...
--
-- Estructura de tabla para la tabla `app_category`
--
...
--
-- Volcado de datos para la tabla `app_category`
--
...
--
-- Volcado de datos para la tabla `app_customer`
--

INSERT INTO `app_customer` (`ID`, `USERNAME`, `PASSWORD`, `EMAIL`, `FULLNAME`, `PHONE`, `WHATSAPP`, `COUNTRY`, `BIRTHDATE`, `ID_GENDER`, `TYPE_REGISTRATION`, `ID_REGISTRATION`, `CREATED_AT`, `IS_OTP`, `ACTIVE`) VALUES
(1, 'azuloro85', '', 'azuloro85@gmail.com', 'Luis Hernandez', '78325858', '78325858', 1, '08/05/1985', '1', 'EMAIL', '', '0000-00-00 00:00:00', b'0', b'1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `app_customer_address`
--
...
--
-- Estructura de tabla para la tabla `app_fiscal`
--
...
--
-- Estructura de tabla para la tabla `app_gender`
--
...
--
-- Volcado de datos para la tabla `app_gender`
--
...
--
-- Estructura de tabla para la tabla `app_global_config`
--
...
--
-- Volcado de datos para la tabla `app_global_config`
--
...
--
-- Estructura de tabla para la tabla `app_item`
--
...
--
-- Volcado de datos para la tabla `app_item`
--
...
--
-- Estructura de tabla para la tabla `app_log`
--
...
CREATE TABLE `app_promotion` (
  ...
  `IMAGE` text DEFAULT NULL,
  `LINK` text NOT NULL,
  `LIMIT_EXCHANGE` int(5) DEFAULT NULL,
  `REDIMM` int(5) DEFAULT NULL,
  `ACTIVE` bit(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
--
-- Estructura de tabla para la tabla `app_rol`
--
...
--
-- Volcado de datos para la tabla `app_rol`
--
...
--
-- Estructura de tabla para la tabla `app_sale`
--
...
--
-- Estructura de tabla para la tabla `app_sale_item`
--
...
--
-- Estructura de tabla para la tabla `app_sale_payment`
--
...
--
-- Estructura de tabla para la tabla `app_sale_tax`
--
...
--
-- Estructura de tabla para la tabla `app_tax`
--
...
--
-- Volcado de datos para la tabla `app_tax`
--
...
--
-- Estructura de tabla para la tabla `app_type_item`
--
...
--
-- Volcado de datos para la tabla `app_type_item`
--
...
--
-- Estructura de tabla para la tabla `app_type_payment`
--
...
--
-- Volcado de datos para la tabla `app_type_payment`
--
...
--
-- Estructura de tabla para la tabla `app_type_promotion`
--
...
--
-- Volcado de datos para la tabla `app_type_promotion`
--
...
--
-- Estructura de tabla para la tabla `app_user_promotion`
--
...
--
-- Indices de la tabla `app_ads`
--
ALTER TABLE `app_ads`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `app_category`
--
...
--
-- Indices de la tabla `app_customer_address`
--
...
--
-- Indices de la tabla `app_fiscal`
--
ALTER TABLE `app_fiscal`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `app_gender`
--
ALTER TABLE `app_gender`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `app_global_config`
--
ALTER TABLE `app_global_config`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `app_item`
--
...
--
-- Indices de la tabla `app_rol`
--
ALTER TABLE `app_rol`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `app_sale`
--
...
--
-- Indices de la tabla `app_sale_item`
--
...
--
-- Indices de la tabla `app_sale_payment`
--
...
--
-- Indices de la tabla `app_sale_tax`
--
...
--
-- Indices de la tabla `app_store`
--
ALTER TABLE `app_store`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `app_tax`
--
ALTER TABLE `app_tax`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `app_type_item`
--
ALTER TABLE `app_type_item`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `app_type_payment`
--
ALTER TABLE `app_type_payment`
  ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `app_type_promotion`
--
...
--
-- Indices de la tabla `app_user_promotion`
--
...
--
-- AUTO_INCREMENT de la tabla `app_ads`
--
ALTER TABLE `app_ads`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `app_category`
--
ALTER TABLE `app_category`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `app_customer`
--
ALTER TABLE `app_customer`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `app_customer_address`
--
ALTER TABLE `app_customer_address`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `app_fiscal`
--
ALTER TABLE `app_fiscal`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `app_gender`
--
ALTER TABLE `app_gender`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `app_item`
--
ALTER TABLE `app_item`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `app_log`
--
ALTER TABLE `app_log`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `app_promotion`
--
ALTER TABLE `app_promotion`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `app_sale`
--
ALTER TABLE `app_sale`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `app_sale_item`
--
ALTER TABLE `app_sale_item`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `app_sale_payment`
--
ALTER TABLE `app_sale_payment`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `app_sale_tax`
--
ALTER TABLE `app_sale_tax`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `app_store`
--
ALTER TABLE `app_store`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `app_tax`
--
ALTER TABLE `app_tax`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT de la tabla `app_user_promotion`
--
ALTER TABLE `app_user_promotion`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
